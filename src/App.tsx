...
import parseTransactionData, { FileWithPath } from './parser/parseTransactionData'
        ...
        async function getTransactionData() {
          try {
            ...
            for (let i = 0; i < e.dataTransfer.files.length; i++) {
              files.push(e.dataTransfer.files.item(i) as FileWithPath)
            }

            const data = await parseTransactionData(files)
            setData(data)
